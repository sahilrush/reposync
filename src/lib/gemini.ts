...
export async function summariseCode(doc: Document) {
  ...
  try {
    ...
    const response = await model.generateContent([
      ...
      `You are onboarding a junior software engineer and explaining to them the purpose of the ${doc.metadata.source} file. You want to provide a brief summary of the file 
            Here is the code :
    ---
    ${code}
    ---
